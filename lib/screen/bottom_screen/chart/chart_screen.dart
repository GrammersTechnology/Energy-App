                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      "  ${controller.data?.fyllingsgrad.toString().substring(0, 4)}",
                                                      style: const TextStyle(
                                                          fontSize: 17,
                                                          fontWeight:
                                                              FontWeight.w600),
                                                        ...
                                                        style: TextStyle(
                                                            ...
                                                            fontWeight:
                                                                FontWeight
                                                                    .w600)),
                                                    Text(
                                                        "  ${controller.data!.kapasitetTWh.toString().substring(0, 4)}",
                                                        style: const TextStyle(
                                                            fontSize: 17,
                                                            fontWeight:
                                                                FontWeight
                                                        ...
                                                        style: TextStyle(
                                                            ...
                                                            fontWeight:
                                                                FontWeight
                                                                    .w600)),
                                                    Text(
                                                        " ${controller.data!.fyllingTWh.toString().substring(0, 4)}",
                                                        style: const TextStyle(
                                                            fontSize: 17,
                                                            fontWeight:
                                                                FontWeight
                                              ...
                                              children: [
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                        "${controller.data!.fyllingsgradForrigeUke.toString().substring(0, 4)} %",
                                                        style: const TextStyle(
                                                          fontSize: 15,
                                                          fontWeight:
                                                              FontWeight.w500,
                                                ...
                                                Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                        "${controller.data!.endringFyllingsgrad.toString().substring(0, 4)} %",
                                                        style: const TextStyle(
                                                          fontSize: 15,
                                                          fontWeight:
                                                              FontWeight.w500,
